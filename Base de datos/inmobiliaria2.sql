...
INSERT INTO `pago` (`Id_Pago`, `Id_Contrato`, `Importe`, `Mes`, `Fecha`, `Multa`, `Id_Creado_Por`, `Id_Terminado_Por`, `Estado_Pago`) VALUES
(1, 1, 50000, 7, '2024-07-15 00:00:00', 0, 1, NULL, 1);
